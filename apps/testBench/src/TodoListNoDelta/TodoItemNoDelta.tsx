import {useTodoScopeNoDelta} from "~/TodoListNoDelta/TodoScopeNoDelta";
import {Todo} from "~/TodoList/TodoScope";

export const TodoItemNoDelta = (props: { todo: Todo }) => {
    const {markCompleteState, removeTodo} = useTodoScopeNoDelta()
